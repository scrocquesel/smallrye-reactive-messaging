...
class ConfigResolverTest {
    ...
    void emptyConsumerConfig() {
        ...
        ConsumerConfigurationData<?> conf = configResolver
                .getConsumerConf(new PulsarConnectorIncomingConfiguration(new MapBasedConfig()));
    ...
    void mapConsumerConfig() {
        ...
        PulsarConnectorIncomingConfiguration ic = new PulsarConnectorIncomingConfiguration(new MapBasedConfig()
    ...
    void emptyClientConfig() {
        ...
        ClientConfigurationData conf = configResolver
                .getClientConf(new PulsarConnectorCommonConfiguration(new MapBasedConfig()));
        Map<String, Object> map = configResolver.configToMap(conf);
        assertThat(map).containsKeys(
    ...
    void mapClientConfig() {
        ...
        PulsarConnectorCommonConfiguration cc = new PulsarConnectorCommonConfiguration(new MapBasedConfig()
    ...
    void emptyProducerConfig() {
        ...
        ProducerConfigurationData conf = configResolver
                .getProducerConf(new PulsarConnectorOutgoingConfiguration(new MapBasedConfig()));
        Map<String, Object> map = configResolver.configToMap(conf);
        assertThat(map).containsKeys(
                "accessMode",
                "autoUpdatePartitions",
    ...
    void mapProducerConfig() {
        ...
        PulsarConnectorOutgoingConfiguration oc = new PulsarConnectorOutgoingConfiguration(new MapBasedConfig()
