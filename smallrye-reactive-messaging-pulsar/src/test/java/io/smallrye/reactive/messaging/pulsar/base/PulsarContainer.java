...
public class PulsarContainer extends GenericContainer<PulsarContainer> {
    ...
    public static final DockerImageName PULSAR_IMAGE = DockerImageName.parse("apachepulsar/pulsar:2.10.2");
    ...
    protected void containerIsStarting(InspectContainerResponse containerInfo, boolean reused) {
        ...
        command += "bin/apply-config-from-env.py conf/standalone.conf && bin/pulsar standalone";
        command += " --no-functions-worker -nss";
        copyFileToContainer(
